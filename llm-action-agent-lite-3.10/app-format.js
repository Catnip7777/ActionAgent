(() => {
  ...
  function parseActionsFromTexts(...texts) {
    const allActions = [];
    const seen = new Set();
  ...
  window.__agentFormat = { isActionBlockEscaped, tryParseActionInner, findTagPositions, collectXmlTagBlocks, collectMarkdownFenceBlocks, collectFormatBlocks, parseActions, parseActionsFromTexts, findUnparsedActionBlocks, formatActionBlock, stripActionBlocks, getFormatPreview, escapeRegexStr };
})();
